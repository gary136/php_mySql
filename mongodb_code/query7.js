...
// print("===================================")
// var explainObj2 = db.usersNonIndex.find({username:'user3333'}).explain("executionStats");
// printjson(explainObj2.executionStats)


// var explainObj = db.usersNonIndex.find({"_id" : ObjectId("5ad2ddb5f912fbceb2061e89")}).explain("executionStats");
