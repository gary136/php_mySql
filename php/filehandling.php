...
if(file_exists("sometext.txt")){
    ...
    fclose($myFile);
    echo "<p>This file certainly exists.</p>";
} else{
...
fwrite($fileHandle, "This is new content") or die("Unable to write in file");
$fileContent = file_get_contents("sometext.txt") or die("Unable to read file");
var_dump($fileContent);
?>
...
<?php
file_put_contents("sometext.txt", "\r This is some other new content", FILE_APPEND) or die("Unable to write in file");
$fileContent = file_get_contents("sometext.txt") or die("Unable to read file");
var_dump($fileContent);
?>
